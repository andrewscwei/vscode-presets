...
echo "Exporting ${COLOR_CYAN}settings.json${COLOR_RESET}..."
cp -rf "${SRC}/settings.json" "${CWD}/Files/settings.json"

echo "Exporting ${COLOR_CYAN}keybindings.json${COLOR_RESET}..."
cp -rf "${SRC}/keybindings.json" "${CWD}/Files/keybindings.json"

echo "Exporting extensions to ${COLOR_CYAN}extensions.list${COLOR_RESET}..."
